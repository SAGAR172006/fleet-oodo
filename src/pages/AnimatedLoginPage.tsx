...
import { FleetFlowLogo } from "@/assets/FleetFlowLogo";
...
export default function AnimatedLoginPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-green-600/90 via-green-500 to-green-600/80 p-12 text-white">
        <div className="relative z-20">
          <div className="flex items-center gap-2 text-lg font-semibold">
            <div className="size-10 rounded-lg bg-white/10 backdrop-blur-sm flex items-center justify-center">
              <FleetFlowLogo className="size-6 text-white" />
            </div>
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="lg:hidden flex items-center justify-center gap-2 text-lg font-semibold mb-12">
            <div className="size-10 rounded-lg bg-green-500/10 flex items-center justify-center">
              <FleetFlowLogo className="size-6 text-green-600" />
            </div>
            <span className="text-xl">
              <span className="font-bold text-green-600">fleet</span>
              <span className="font-light text-gray-800">flow</span>
            </span>
          </div>
